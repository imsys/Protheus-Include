...
#DEFINE FWOCN_LST	"QHeaderView::section { color: #000000; border-image:url(rpo:fwstd_brw_hdr_nml.png) 2 2 2 2 stretch; border: 1px solid #A0A0A0; }"+;
...
#DEFINE FWOCN_BRW	"QHeaderView::section { color: #004A77; "+;
